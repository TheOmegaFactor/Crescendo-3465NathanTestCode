...
public final class Constants {
    ...
    public final static class Swerve {
        ...
        public static final double trackLength = Units.inchesToMeters(14);
        ...
        public static final boolean invertGyro = false; // Always ensure Gyro is CCW+ CW- (Clockwise is increasing rotation values)
